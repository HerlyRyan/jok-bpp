...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form method="GET">
            <input type="hidden" name="page" value="laporanUsulanMasuk">
            <div class="row">
            ...
            <div class="d-flex justify-content-end">
                ...
                <a href="?page=laporanUsulanMasuk" class="btn btn-secondary mr-2">
                ...
                ?>
                <a href="../../laporan/usulan-masuk/print.php?<?php echo $queryString; ?>" target="_blank" class="btn btn-success">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Laporan Data Usulan Masuk</h6>
    </div>
    <div class="card-body">
