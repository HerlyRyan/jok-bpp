...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($con, "INSERT INTO bidang (nama_bidang) VALUES('$nama_bidang')");
    if ($result) {
            ...
            <div class="card-body">
                <form action="" method="post">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nama_bidang" placeholder="Masukan Nama Bidang..." required>
                        </div>
                    </div>
