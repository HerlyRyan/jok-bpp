        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php
                    // Base query
                    $query = "SELECT pengaduan.*, users.username FROM pengaduan JOIN users ON pengaduan.user_id = users.user_id WHERE status = 'Masuk'";
                    ...
                    ?>
                        <tr>
                            <td><?= $no++; ?></td>
                            <td><?= htmlspecialchars(ucfirst($data['username'])); ?></td>
